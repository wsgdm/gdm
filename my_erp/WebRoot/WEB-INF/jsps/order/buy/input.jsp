...
$(function(){
	$("#selectSupplier").change(function(){
		...
		loadPt(supplierId);
		var productTypeId = $(".goodsType").val();
		if(productTypeId > 0){
			var tr = $("#mytr");
			loadPro(tr,productTypeId);
		}	
		var productId = $(".goods").val();
		setPrice($("#mytr"),productId);
		getTotalPrice();
		$("#sup").val($(this).val());
...
<div class="content-right">
	...
	<div class="content-text">
		<form action="${path}/ajax_orderModel_add" method="post">
		<input type="hidden" name="orderModel.supplierId" id="sup"/>
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td width="648px">
							<s:select  id="selectSupplier" class="kuan" list="#supplierList" name="orderModel.supplierId" listKey="supplierId"  listValue="name" headerKey="-1" headerValue="--请选择--"></s:select>
						</td>
						<td height="30">
			...
			<div class="square-order">
				<table id="order" width="100%" border="1" cellpadding="0" cellspacing="0">
					...
					<tr id="mytr" class="trr" align="center" bgcolor="#FFFFFF">
						<td height="30">
							<select class="goodsType" name="productTypeId" style="width:200px">
							</select>
						</td>
						<td>
							<select class="goods" name="productId" style="width:200px">
							</select>
						</td>
						...
						<td  class="prices order_num" align="right" aPrice=""> 元</td>
						<td class="total" align="right" toPrice="">&nbsp;元</td>
						<td>
