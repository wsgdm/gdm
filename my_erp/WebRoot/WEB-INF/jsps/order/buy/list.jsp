...
<script type="text/javascript">
	...
	function viewDetail(orderId){
		...
		diag.OKEvent = function(){
			window.location.href = path + "/orderModel_list"
			diag.close();
		
		};
		diag.show();
			if(orderState == "3"){
			diag.addButton("next","修改",function(){
						var diag1 = new Dialog();
						diag1.Width = 850;
						diag1.Height = 400;
						diag1.ShowButtonRow=true;
						diag1.Title = "修改订单";
						diag1.URL = path + "/orderModel_update?orderModel.orderId="+orderIdStr;
	...
	<div class="content-text">
		...
		<input type="hidden" id="orderState" name="orderModelQuery.orderState" value="<s:property value="orderModelQuery.orderState"/>"/>
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td>到</td>
						<td><td><s:textfield type="text" size="14" name="orderModelQuery.maxTotalPrice"/></td></td>
						<td>
			...
			<div class="square-order">
				<ul>
					<li id="li1"><a href="${path }/orderModel_list?orderModelQuery.orderType=1&orderModelQuery.orderState=1" style="text-decoration: none;color: black">未审核</a></li>
					<li id="li2"><a href="${path }/orderModel_list?orderModelQuery.orderType=1&orderModelQuery.orderState=2" style="text-decoration: none;color: black">审核通过</a></li>
					<li id="li3"><a href="${path }/orderModel_list?orderModelQuery.orderType=1&orderModelQuery.orderState=3" style="text-decoration: none;color: black">审核不通过</a></li>
					<li id="li4"><a href="${path }/orderModel_list?oderModelQuery.orderType=1" style="text-decoration: none;color: black">全部</a></li>
				</ul>
