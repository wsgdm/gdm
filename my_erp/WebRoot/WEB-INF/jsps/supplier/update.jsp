...
$(function(){
	...
	function validName(){
		...
		if(!reg.test(tel)){
			...
			if(ret == "NoOK"){
				if($("#suName").val() != $("#supplierName").val()){
...
<div class="content-right">
	...
	<div class="content-text">
		<div class="square-order">
			<form id="first" action="${path}/ajax_supplier_updateSupplier" method="post">
			<input type="hidden"  id="suName" value="<s:property value="supplier.name"/>" />
