...
<script type="text/javascript">
	...
	function isExistProName(){
		var res = "";
		var proTypeId = $("#productType").val();
		var ProName = $("#ProName").val();
			$.ajax({
			type:"post",
			url:"${path}/ajax_product_vaildProName",
			data:{
				"product.productTypeId":proTypeId,
...
<div class="content-right">
	...
	<div class="content-text">
		<div class="square-order">
			<form id="frist" action="${path}/ajax_product_add" method="post">
