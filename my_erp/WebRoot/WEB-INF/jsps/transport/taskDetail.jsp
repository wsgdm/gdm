...
function getAssginEmp(){
	...
	var result = "";
	$.ajax({
		url:"${path}/ajax_transportOrder_assginOrder",
		type:"post",
		data:{
			"orderModel.orderId":orderId,
			"orderModel.completer":empId
		},
		async:false,
		dataType:"text",
	...
	<div class="content-text">
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						<td>联&nbsp;系&nbsp;人:</td>
						<td class="order_show_msg"><s:property value="orderModel.supplier.contact"/></td>
						<td>联系方式:</td>
						<td class="order_show_msg"><s:property value="orderModel.supplier.tel"/></td>
						<td>商品总量:</td>
			...
			<div class="square-order">
				...
				<table width="100%" border="1" cellpadding="0" cellspacing="0">
					...
					<tr align="right">
						...
						<td width="20%"><s:select id="assginEmp" list="emp" listKey="empId" listValue="name"></s:select></td>
					</tr>
				</table>
				<br/>
