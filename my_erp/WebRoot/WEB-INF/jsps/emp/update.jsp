...
<div class="content-right">
	...
	<div class="content-text">
		<div class="square-order">
			<form action="${path}/ajax_emp_update" id="submitForm" method="post"> 
 			<input type="hidden" id="userName" value="<s:property value="emp.username"/>"/> 
...
<!-- 				      </td> -->
<!-- 				    </tr> -->
					<input  type="hidden" name="emp.password" value="<s:property value="emp.password"/>"/>
				     <tr bgcolor="#FFFFFF">
					  <td colspan="4">&nbsp;</td>
					</tr>
				    <tr  bgcolor="#FFFFFF">
